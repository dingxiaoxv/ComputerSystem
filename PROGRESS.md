...
| 项目 | 内容 |
|------|------|
| 当前章节 | 第 8 章 异常控制流（进行中，§8.1-8.2 已完成） |
| 已完成天数 | Day 1 - Day 28（第 1-3 章主线）、Day 31 - Day 34（第 7 章）、Day 35 - Day 36（§8.1-8.2） |
| 上次学习 | 2026-05-31 |
| 下一步 | 第 8 章 §8.3-8.4.3 进程控制、fork、wait（Day 37）；第 3 章 §3.10.4-3.11 栈保护/浮点汇编待回补 |
